...
distribution with a converted Expo East scene, intended for a downloadable
artifact such as a Hugging Face dataset repository. Upload is a separate release
step; preparation does not publish the scene.
