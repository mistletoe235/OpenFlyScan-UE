...
[a separate source archive](https://huggingface.co/datasets/mistletoe235/openflyscan/resolve/main/HIL-simulator/linux/v0.1.0/THIRD_PARTY_SOURCES/eigen3.tar.gz).
