...
ACarPawn::ACarPawn()
{
    ...
    // OpenFlySplat is a flight/HIL distribution and intentionally ships no car
    // content. Keep the native class loadable without forcing VehicleAdv assets
    // into every editor build or packaged release.
    slippery_mat_ = nullptr;
    non_slippery_mat_ = nullptr;
    ...
    // Preserve the component expected by the inherited car implementation, but
    // do not bind the omitted VehicleAdv engine sound asset.
