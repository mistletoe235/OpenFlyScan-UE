...
ACameraManager::ACameraManager()
    ...
    , mode_(ECameraDirectorMode::CAMERA_DIRECTOR_MODE_FLY_WITH_ME)
    , manual_pose_controller_(nullptr)
    , camera_start_location_(FVector::ZeroVector)
    , initial_ground_obs_offset_(FVector::ZeroVector)
    , camera_start_rotation_(FRotator::ZeroRotator)
    , ext_obs_fixed_z_(false)
    , follow_distance_(0)
    , camera_rotation_lag_enabled_(false)
{
