...
void ASimModeBase::BeginPlay()
{
    ...
    // Keep UE world coordinates stable so generated Gaussian geometry, collision,
    // and the AirSim NED origin remain aligned.
    ...
    // The open-source flight/HIL project intentionally omits AirSim's optional
    // weather content. Do not create its UI/actor graph during startup.
