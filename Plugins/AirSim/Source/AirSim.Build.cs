...
public class AirSim : ModuleRules
{
    ...
    public AirSim(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "ImageWrapper", "RenderCore", "RHI", "PhysicsCore", "AssetRegistry", "ChaosVehicles", "Landscape", "CinematicCamera", "AIModule", "Foliage", "HTTP", "Sockets", "Networking", "StaticMeshDescription", "ImageWriteQueue", "Json", "JsonUtilities", "MeshConversion", "Chaos", "ProceduralMeshComponent", "MeshDescription", "Projects", "Renderer" });
        PrivateDependencyModuleNames.AddRange(new string[] { "UMG", "Slate", "SlateCore", "RenderCore", "NanoGS" });
        ...
        // Compile AirLib with the same UE toolchain and Eigen configuration as
        // the plugin. A separately compiled libAirLib.a changes the ABI of
        // Eigen-containing settings structs on Linux and crashes while reading
        // CameraSetting::position in PawnSimApi::createCamerasFromSettings().
