...
namespace NanoGS::Paged { struct FCaptureReadinessSnapshot; }
...
public:
	...
	/** Build a lifetime-safe, atomic Page snapshot for an external image capture. */
	void BuildPagedCaptureReadinessSnapshot(
