...
IMPLEMENT_GLOBAL_SHADER(FNanoGSPagedBuildActiveIndexCS, "/Plugin/NanoGS/Private/PagedBuildActiveIndex.usf", "MainCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FNanoGSTreeFrontierPrepareCS, "/Plugin/NanoGS/Private/TreeFrontier.usf", "PrepareCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FNanoGSTreeFrontierSplitCS, "/Plugin/NanoGS/Private/TreeFrontier.usf", "SplitCS", SF_Compute);
