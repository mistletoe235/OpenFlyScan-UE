...
public:
	...
	/** Maximum SH bands to keep during import (-1 = auto/use file setting). */
	int32 RequestedMaxSHBands = INDEX_NONE;

	/** Set when the import options dialog is explicitly cancelled by the user. */
	bool bImportOptionsCanceled = false;
