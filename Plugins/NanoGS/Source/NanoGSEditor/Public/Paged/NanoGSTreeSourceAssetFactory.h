...
#include "NanoGSTreeSourceAssetFactory.generated.h"

UCLASS()
class NANOGSEDITOR_API UNanoGSTreeSourceAssetFactory : public UFactory, public FReimportHandler
{
	GENERATED_BODY()
public:
	UNanoGSTreeSourceAssetFactory();
