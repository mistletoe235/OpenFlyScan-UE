...
`Docs/HIL_QUICKSTART.md`: remove propellers and verify DJI Simulator activation
before control tests. A connected network peer is not proof of safe simulation.
